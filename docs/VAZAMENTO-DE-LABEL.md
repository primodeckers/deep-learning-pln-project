...
| `objeto_html_limpo` | *(experimento)*        | Limpeza extra; ganho pequeno na Tabela 7 — ver §6.3 |
...
**Voto do grupo:** *[ ] fazer run de contraste · [ ] não necessário*
...
**Voto do grupo:** *[ ] adotar como oficial · [x] manter objeto_html · [ ] testar run comparativo*
...
**Voto do grupo:** *[ ] manter proxy · [ ] explorar subset anotado*
...
*Preencher em reunião — data, quem participou, decisão.*


| Data         | Participantes | Tópico                         | Decisão |
| ------------ | ------------- | ------------------------------ | ------- |
| *AAAA-MM-DD* |               | Mitigação principal (§4)       |         |
